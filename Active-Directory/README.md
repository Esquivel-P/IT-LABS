...
![Active Directory Lab Topology](screenshots/ad-topology.png)
...
![OS Selection](screenshots/01-os-desktop-experience.png)

**Installed Oracle VirtualBox Guest Additions**  
![Guest Additions Setup](screenshots/02-guest-additions-setup.png)  
![Guest Additions Installing](screenshots/03-guest-additions-installing.png)

## 2. Domain Controller Promotion

**Promoted server to Domain Controller**  
![Domain Promotion Wizard](screenshots/04-domain-promotion-wizard.png)

**Active Directory Domain Services role installation completed successfully**  
![AD DS Installation Success](screenshots/05-ad-ds-installation-success.png)

## 3. Active Directory Users and Groups

**Active Directory Users and Computers – Domain users created**  
![ADUC Users](screenshots/06-aduc-users.png)
...
![HR Group Membership](screenshots/08-hr-group-members.png)
...
![HR File Share](screenshots/09-hr-file-share.png)

**Client VM successfully mapped \\LAB.local\HR as drive H:**  
![Mapped Network Drive](screenshots/10-mapped-hr-drive-client.png)

## 5. Verification and Management

**PowerShell verification of domain configuration**  
![PowerShell Verification](screenshots/11-powershell-domain-verification.png)
...
- Gained practical experience with core AD tools: Active Directory Users and Computers (ADUC), domain promotion wizard, and PowerShell for verification and management.
- Understood the complete end-to-end workflow: OS installation → domain promotion → object creation → resource sharing → client integration.
...
**Note:** This was an isolated lab environment. The client and server communicated over a Host-Only network, with NAT used only when internet access was temporarily needed.
